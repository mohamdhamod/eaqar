    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            tableEl?.addEventListener('click', function (e) {
                ...
                if (viewBtn) {
                    ...
                    if (confirm(t.confirmDelete || (window.i18n && window.i18n.messages && window.i18n.messages.are_you_sure) || '')) {
                        CRUDManager.deleteItem(`dashboard/team_members/${data.id}`, {
                            onSuccess: () => { try { table.ajax.reload(); } catch (_) { window.location.reload(); } },
            ...
            tableEl?.addEventListener('change', function (e) {
                ...
                CRUDManager.requestJson(`dashboard/team_members/${data.id}/updateActiveStatus`, {
                    method: 'POST',
                    data: { active: isActive },
                    showSuccessToast: false,
                    onSuccess: () => { try { table.ajax.reload(null, false); } catch (_) { /* no-op */ } }
                });
            });
