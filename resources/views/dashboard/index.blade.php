                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                        <a href="{{ route('users.index') }}" class="btn btn-light btn-lg">
                            <i class="bi bi-people me-2"></i>{{ __('translation.dashboard.manage_users') }}
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card h-100 border-0 shadow-sm rounded-3">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold text-success mb-1">{{ number_format($statistics['countries'] ?? 0) }}</h3>
                        <small class="text-muted">{{ __('translation.dashboard.stats.countries') }}</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card h-100 border-0 shadow-sm rounded-3">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold text-info mb-1">{{ number_format($statistics['configurations'] ?? 0) }}</h3>
                        <small class="text-muted">{{ __('translation.dashboard.stats.configurations') }}</small>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <h5 class="card-title fw-semibold mb-0">{{ __('translation.dashboard.recent_users') ?? 'Recent Users' }}</h5>
                        </div>
                    ...
                    <div class="card-body p-0">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    <thead class="bg-light">
                                        <tr>
                                            <th class="border-0 text-muted small fw-semibold px-4 py-3">{{ __('translation.dashboard.table.user') ?? 'User' }}</th>
                                            <th class="border-0 text-muted small fw-semibold">{{ __('translation.dashboard.table.email') ?? 'Email' }}</th>
                                            <th class="border-0 text-muted small fw-semibold">{{ __('translation.dashboard.table.role') ?? 'Role' }}</th>
                                    ...
                                    <tbody>
                                        @foreach($recentUsers as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-primary bg-opacity-10 text-primary">{{ $user->roles->first()?->name ?? 'User' }}</span>
                                                </td>
                                                <td>
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted mt-3">{{ __('translation.dashboard.no_data') }}</p>
                            </div>
                        @endif
                    </div>
                </div>
                            ...
                            <div class="col-6">
                                <a href="{{ route('countries.index') }}" class="text-decoration-none">
                                    <div class="text-center p-3 rounded-3 bg-primary bg-opacity-10 hover-lift" style="transition: all 0.3s;">
                                        ...
                                        <div class="fw-semibold small text-primary">{{ __('translation.dashboard.countries') }}</div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-6">
