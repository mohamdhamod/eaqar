...
@section('page_title', __('translation.property.add_new_property') . ' — ' . config('app.name'))
    ...
    <div class="container">
        <nav aria-label="breadcrumb" class="mb-2">
            <ol class="breadcrumb small mb-0">
                ...
                <li class="breadcrumb-item active text-white">{{ __('translation.property.add_new_property') }}</li>
            </ol>
        </nav>
        <h1 class="prop-form-hero__title">{{ __('translation.property.add_new_property') }}</h1>
        <p class="prop-form-hero__sub">{{ __('translation.property.fill_details_below') }}</p>
    </div>
</div>
            ...
            <div class="col-lg-8">
                ...
                <div class="prop-form-card">
                    <div class="prop-form-card__header">
                        ...
                        <h2 class="prop-form-card__title">
                            {{ __('translation.property.basic_information') }}
                        </h2>
                    </div>
                ...
                <div class="prop-form-card">
                    <div class="prop-form-card__header">
                        ...
                        <h2 class="prop-form-card__title">
                            {{ __('translation.property.property_details') }}
                        </h2>
                    </div>
                    <div class="prop-form-card__body">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select select2 @error('property_type_id') is-invalid @enderror"
                                    ...
                                    @foreach($filterOptions['property_types'] as $type)
                                        <option value="{{ $type->id }}" @selected(old('property_type_id') == $type->id)>{{ $type->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select select2 @error('operation_type_id') is-invalid @enderror"
                                    ...
                                    @foreach($filterOptions['operation_types'] as $operation)
                                        <option value="{{ $operation->id }}" @selected(old('operation_type_id') == $operation->id)>{{ $operation->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        {{-- Row: Rooms / Bathrooms / Floor / Total floors / Building age (counters) --}}
                        <div class="row g-3">
                            <div class="col-6 col-md-4">
                                ...
                                <div class="prop-counter @error('rooms') is-invalid @enderror">
                                    ...
                                    <input type="number" class="prop-counter__input" id="rooms" name="rooms"
                                           value="{{ old('rooms', 0) }}" min="0" required>
                            ...
                            <div class="col-6 col-md-4">
                                ...
                                <div class="prop-counter @error('bathrooms') is-invalid @enderror">
                                    ...
                                    <input type="number" class="prop-counter__input" id="bathrooms" name="bathrooms"
                                           value="{{ old('bathrooms', 0) }}" min="0" required>
                            ...
                            <div class="col-6 col-md-4">
                                ...
                                <div class="prop-counter @error('building_age') is-invalid @enderror">
                                    ...
                                    <input type="number" class="prop-counter__input" id="building_age" name="building_age"
                                           value="{{ old('building_age', 0) }}" min="0">
                ...
                <div class="prop-form-card">
                    ...
                    <div class="prop-form-card__body">
                        <x-property-images-upload :isEditMode="false" formId="propertyForm" />
                    </div>
                </div>
                ...
                <div class="prop-form-submit">
                    <div class="prop-form-submit__header">
                        <p class="prop-form-submit__title">
                            <i class="fas fa-paper-plane me-2"></i>{{ __('translation.property.publish_listing') }}
                        </p>
                    </div>
                    <div class="prop-form-submit__body">
                        <button type="submit" class="btn btn-primary btn-lg w-100 fw-bold mb-3">
                            <i class="fas fa-save me-2"></i>{{ __('translation.property.add_property') }}
                        </button>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.prop-counter__btn').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            else if (btn.dataset.action === 'dec') val = Math.max(parseInt(input.min) || 0, val - step);
            input.value = val;
        });
    });
