...
<section class="ag-hero">
    <div class="container position-relative z-1">
        <nav class="ag-hero__breadcrumb mb-2">
            ...
            <span class="active">{{ __('translation.agency.my_agency') }}</span>
        </nav>
...
<div class="container pb-4 mt-4">
                ...
                <div class="agency-details">
                    ...
                    @if($agency->address)
                        <div class="info-item-compact">
                            <i class="fas fa-map-marker-alt info-icon-small d-flex align-items-center justify-content-center"></i>
                            <div>
                    ...
                    {{-- Member Since --}}
                    <div class="info-item-compact">
                        <i class="fas fa-calendar info-icon-small d-flex align-items-center justify-content-center"></i>
                        <div>
    ...
    {{-- Listings Section (Admin and Agent only) --}}
    @if(auth()->check() && auth()->user()->hasAnyRole(['Admin', 'Agent']))
